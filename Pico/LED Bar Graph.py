...
# Hopefully, I will make a detailed guide about doing this eventually...



# SETUP (This will take a bit of time to setup)
# -------------------------------------------------------
# Bar Graph LED Placement
# 1. Place the Bar Graph LED in the middle of the breadboard
# (Face label towards the left of the breadboard to avoid confusion later)
...
# LED Cable Placement
# 1. Update and use the LED Variables list below while you are connecting the cables from the Pico to the LED Bar Graph.
...
while __name__ == '__main__':
    try:
        # Making sure that everything is off before
    ...
    # There are bugs with doing this unfortunately...
    # Proceed with caution if you wish to uncomment below! 
    # except KeyboardInterrupt:
    #    exiting()

        
# CE Solution = https://forums.raspberrypi.com/viewtopic.php?t=179521